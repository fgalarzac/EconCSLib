...
\colorbox{closefill}{%
  ...
  Completed work is selected into a clean branch based on public \file{main}.
  A reviewed path allowlist, current canonical
  ...
  the exact candidate. Only reviewed public artifacts and canonical evidence
  named by that allowlist are carried into the public commit.}}
