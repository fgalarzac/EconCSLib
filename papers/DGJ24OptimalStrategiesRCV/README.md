...
- Outside-Lean proof plan: `DGJ24OptimalStrategiesRCV/FORMALIZATION_PLAN.md`
- Final validation report: `DGJ24OptimalStrategiesRCV/FINAL_VALIDATION_REPORT.md`
- Next-agent starting point: `DGJ24OptimalStrategiesRCV/START_HERE_NEXT_AGENT.md`
- Stopping-point handoff: `DGJ24OptimalStrategiesRCV/HANDOFF_2026-06-29_STOPPING_POINT.md`
- Dependency DAG: `DGJ24OptimalStrategiesRCV/DependencyDAG.tex`
- Rendered DAG: `DGJ24OptimalStrategiesRCV/DependencyDAG.pdf`
