...
At a constrained limit point, the checked conclusion is either a zero aggregate
direction or no feasible aggregate direction. In the paper's full space, the
second alternative is impossible; the precise source reading and its effect
are recorded in the [Theorem 3 constrained-space clarification](docs/THEOREM3_CONSTRAINED_SPACE_SOURCE_NOTE.md).
