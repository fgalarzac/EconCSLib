...
7.2 require nondegenerate logarithmic domains. Lemma 8.1 and Theorem 8.2 use
the later journal monotone-offer condition in place of the preliminary SODA
cross-bidder implication. The public [source clarifications](docs/SOURCE_CLARIFICATIONS.md)
state the exact readings and their effect. The logarithmic-domain items are
clarifications; the Lemma 8.1 and Theorem 8.2 changes are source corrections.
None is a status caveat, and archival equivalence is not claimed.
