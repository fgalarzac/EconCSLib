...
- Outside-Lean proof plan: `DGJ26PracticalDynamicsRCV/FORMALIZATION_PLAN.md`
- Final validation report: `DGJ26PracticalDynamicsRCV/FINAL_VALIDATION_REPORT.md`
- Next-agent starting point: `DGJ26PracticalDynamicsRCV/START_HERE_NEXT_AGENT.md`
- Stopping-point handoff: `DGJ26PracticalDynamicsRCV/HANDOFF_2026-06-29_STOPPING_POINT.md`
- Dependency DAG: `DGJ26PracticalDynamicsRCV/DependencyDAG.tex`
- Rendered DAG: `DGJ26PracticalDynamicsRCV/DependencyDAG.pdf`
