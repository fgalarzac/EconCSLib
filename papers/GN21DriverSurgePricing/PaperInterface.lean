...
theorem review_section2_single_state_renewal_reward_iid_bridge {Ω : Type u_1}
  ...
  apply section2_single_state_renewal_reward_iid_bridge
...
theorem review_lemma2_switch_probability_formula (lambdaIJ lambdaJI s : ℝ) :
  ...
  apply lemma2_switch_probability_formula
...
theorem review_remark1_switch_probability_per_time_strictAntiOn (lambdaIJ lambdaJI : ℝ)
  ...
  apply remark1_switch_probability_per_time_strictAntiOn <;> assumption
...
theorem review_remark3_switch_probability_per_time_tendsto_at_zero (lambdaIJ lambdaJI : ℝ)
  ...
  apply remark3_switch_probability_per_time_tendsto_at_zero
  assumption
...
theorem review_remark4_switch_time_minus_switch_probability_nonneg (lambdaIJ lambdaJI τ : ℝ)
  ...
  apply remark4_switch_time_minus_switch_probability_nonneg <;> assumption
...
theorem lemma5_policy_form_of_explicit_positive_response_shape (mu : MeasureTheory.Measure TripLength)
  ...
  apply lemma5_fixed_response_policy_form <;> assumption
...
theorem review_lemma5_null_interval_reward_invariance
    ...
    (hpolicy_ae : assumption_policy_equalities_modulo_null_sets mu Rhat) :
...
structure GN21Lemma5AENullEndpointVariation
  ...
  policy_equalities_modulo_null_sets :
    assumption_policy_equalities_modulo_null_sets mu Rhat
...
theorem review_lemma6_upper_endpoint_derivative_formula
  ...
  apply lemma6_upper_endpoint_derivative_formula <;> assumption
...
theorem review_lemma7_affine_positive_additive_response_quasi_convex
  ...
  apply lemma7_affine_positive_additive_response_quasi_convex <;> assumption
...
theorem review_lemma8_affine_negative_additive_response_quasi_concave
  ...
  strictQuasiConcaveOnPositive fun u =>
    gn21Lemma6Response (gn21SwitchProb lambdaIJ lambdaJI u) u (m * u + a) Qi Qj Ti Tj Ri Rj := by
  apply lemma8_affine_negative_additive_response_quasi_concave <;> assumption
...
theorem review_lemma9_surge_derivative_positive_of_acceptAll_bounds
  ...
  apply lemma9_surge_derivative_positive_of_acceptAll_bounds <;> assumption
...
theorem review_lemma10_nonsurge_derivative_positive_of_acceptAll_bounds
  ...
  apply lemma10_nonsurge_derivative_positive_of_acceptAll_bounds <;> assumption
    ...
    (((0 < (2 : ℝ) ∧
      ...
      ¬ dynamicIncentiveCompatible
        (gn21MeasuredDynamicRewardFunctional theorem2BothStatesContinuousMu
          theorem2BothStatesContinuousArrival ((1 : ℝ) / 4) ((1 : ℝ) / 4)
          (fun i => multiplicativePricing (theorem2BothStatesContinuousM i))) :=
    ⟨theorem2_multiplicative_measured_profitable_positive_finite_cutoff_deviations_both_states_explicit_continuous,
      theorem2_multiplicative_measured_not_ic_both_states_explicit_continuous⟩
...
theorem theorem4_one_threshold_structured_component_of_explicit_brackets
  ...
  apply theorem4_structural_policy_representatives_of_gn21_bracket_source_data
  assumption
...
structure GN21Theorem4AENullEndpointVariation
  ...
  policy_equalities_modulo_null_sets :
    ∀ (rho : Fin 2 → TripPolicy), dynamicFeasibleOpenPolicy rho →
      ∀ i : Fin 2,
        assumption_policy_equalities_modulo_null_sets (mu i)
...
/--
Legacy compatibility engine for the pre-remediation Theorem 4 route.  Its raw
endpoint-sign package is no longer an audited source-facing route; retain it
only while downstream compatibility users are migrated to
`review_theorem4_full_structural_policy_forms_direct`.
-/
...
/-- Legacy compatibility bridge for the former non-surge Theorem 4 route.
It is stronger than the printed endpoint condition and is not used by the
audited literal-endpoint review surface below. -/
...
/-- Legacy compatibility bridge for the former surge Theorem 4 route.
It is stronger than the printed endpoint condition and is not used by the
audited literal-endpoint review surface below. -/
...
/-- Legacy compatibility surface for the former global-marginal bridge.
It is retained only for dependent code; the audited paper-facing result is
`review_theorem4_full_structural_policy_forms_direct` below. -/
...
/-- Legacy compatibility theorem for the pre-remediation endpoint-record
route. It is retained for dependent code and is not an audited source-facing
Theorem 4 declaration. -/
...
/-! ## Transparent source-result specifications -/

/- Each declaration below is an explicit source-facing proposition. Its
companion proof wrapper makes the direct paper-interface route reviewable
without relying on a custom elaborator. -/

def review_proposition3_1_affine_single_state_icSpec : Prop :=
  ∀ (mu : MeasureTheory.Measure TripLength)
  (arrivalRate m a : ℝ)
  (haccept_mass : singleStateTripMass mu acceptAllPolicy = 1)
  (htime_integrable_acceptAll : MeasureTheory.IntegrableOn (fun τ : TripLength => τ) acceptAllPolicy mu)
...
theorem review_proposition3_1_affine_single_state_icSpec_proof : review_proposition3_1_affine_single_state_icSpec := by
  exact review_proposition3_1_affine_single_state_ic

def review_theorem1_single_state_threshold_best_responseSpec : Prop :=
  ∀
  (μ : MeasureTheory.Measure TripLength) (arrivalRate : ℝ) (w : PricingFunction)
  (hrate_measurable : Measurable fun τ => w τ / τ) (hrate_nonneg : ∀ (τ : TripLength), 0 < τ → 0 ≤ w τ / τ)
  (hfinite_acceptAll : μ acceptAllPolicy ≠ ⊤) (hw_integrable_acceptAll : MeasureTheory.IntegrableOn w acceptAllPolicy μ)
...
theorem review_theorem1_single_state_threshold_best_responseSpec_proof : review_theorem1_single_state_threshold_best_responseSpec := by
  exact review_theorem1_single_state_threshold_best_response

def review_lemma4_single_state_threshold_uniquenessSpec : Prop :=
  ∀ (μ : MeasureTheory.Measure TripLength)
  (arrivalRate : ℝ) (w : PricingFunction) (hrate_measurable : Measurable fun τ => w τ / τ)
  (hrate_nonneg : ∀ (τ : TripLength), 0 < τ → 0 ≤ w τ / τ) (hfinite_acceptAll : μ acceptAllPolicy ≠ ⊤)
  (hw_integrable_acceptAll : MeasureTheory.IntegrableOn w acceptAllPolicy μ)
  (htime_integrable_acceptAll : MeasureTheory.IntegrableOn (fun τ => τ) acceptAllPolicy μ) (hlambda : 0 < arrivalRate),
...
theorem review_lemma4_single_state_threshold_uniquenessSpec_proof : review_lemma4_single_state_threshold_uniquenessSpec := by
  exact review_lemma4_single_state_threshold_uniqueness

def review_lemma1_measured_dynamic_reward_decompositionSpec : Prop :=
  ∀
    {Omega : Type u_1} [MeasurableSpace Omega]
    {POmega : Measure Omega}
    {muI muJ : Measure TripLength}
...
theorem review_lemma1_measured_dynamic_reward_decompositionSpec_proof : review_lemma1_measured_dynamic_reward_decompositionSpec := by
  exact review_lemma1_measured_dynamic_reward_decomposition

def review_lemma2_switch_probability_formulaSpec : Prop :=
  ∀ (lambdaIJ lambdaJI s : ℝ),
    gn21SwitchProb lambdaIJ lambdaJI s = lambdaIJ / (lambdaIJ + lambdaJI) * (1 - Real.exp (-(lambdaIJ + lambdaJI) * s))

theorem review_lemma2_switch_probability_formulaSpec_proof : review_lemma2_switch_probability_formulaSpec := by
  exact review_lemma2_switch_probability_formula

def review_lemma3_measured_time_fraction_formulaSpec : Prop :=
  ∀
    {Omega : Type u_1} [MeasurableSpace Omega]
    {POmega : Measure Omega}
    {muI muJ : Measure TripLength}
...
theorem review_lemma3_measured_time_fraction_formulaSpec_proof : review_lemma3_measured_time_fraction_formulaSpec := by
  exact review_lemma3_measured_time_fraction_formula

def review_lemma6_upper_endpoint_derivative_formulaSpec : Prop :=
  ∀
  (arrivalRate switchRate lowerEndpoint u Qj Tj Wj Ri Rj : ℝ) (density switchProb payment : ℝ → ℝ)
  (harrival_pos : 0 < arrivalRate) (hu : 0 < u) (hQj_pos : 0 < Qj)
  (hTi_pos : 0 < gn21EndpointTiPath arrivalRate lowerEndpoint density u) (hTj_pos : 0 < Tj)
...
theorem review_lemma6_upper_endpoint_derivative_formulaSpec_proof : review_lemma6_upper_endpoint_derivative_formulaSpec := by
  exact review_lemma6_upper_endpoint_derivative_formula

def review_lemma7_affine_positive_additive_response_quasi_convexSpec : Prop :=
  ∀
  (m a Qi Qj Ti Tj Ri Rj lambdaIJ lambdaJI : ℝ) (hm_pos : 0 < m) (ha_pos : 0 < a) (hdelta_ji_nonpos : Rj - Ri ≤ 0)
  (hstate_weight_pos : 0 < Qi / Ti + Qj / Tj) (hlambdaIJ : 0 < lambdaIJ) (hsum : 0 < lambdaIJ + lambdaJI) (hTi : Ti ≠ 0)
  (hTj : Tj ≠ 0),
...
theorem review_lemma7_affine_positive_additive_response_quasi_convexSpec_proof : review_lemma7_affine_positive_additive_response_quasi_convexSpec := by
  exact review_lemma7_affine_positive_additive_response_quasi_convex

def review_lemma8_affine_negative_additive_response_quasi_concaveSpec : Prop :=
  ∀
  (m a Qi Qj Ti Tj Ri Rj lambdaIJ lambdaJI : ℝ) (hm_pos : 0 < m) (ha_neg : a < 0) (hdelta_ji_nonneg : 0 ≤ Rj - Ri)
  (hstate_weight_pos : 0 < Qi / Ti + Qj / Tj) (hlambdaIJ : 0 < lambdaIJ) (hsum : 0 < lambdaIJ + lambdaJI) (hTi : Ti ≠ 0)
  (hTj : Tj ≠ 0),
...
theorem review_lemma8_affine_negative_additive_response_quasi_concaveSpec_proof : review_lemma8_affine_negative_additive_response_quasi_concaveSpec := by
  exact review_lemma8_affine_negative_additive_response_quasi_concave

def review_lemma9_surge_derivative_positive_of_acceptAll_boundsSpec : Prop :=
  ∀
  (arrivalRate lowerEndpoint u T1 Q1 T2 Q2 Tbar2 Qbar2 switch21 switch12 m R1 z ratio : ℝ) (density : ℝ → ℝ)
  (harrival_pos : 0 < arrivalRate) (hdensity_pos : 0 < density u) (hQ1_pos : 0 < Q1)
  (hden :
...
theorem review_lemma9_surge_derivative_positive_of_acceptAll_boundsSpec_proof : review_lemma9_surge_derivative_positive_of_acceptAll_boundsSpec := by
  exact review_lemma9_surge_derivative_positive_of_acceptAll_bounds

def review_lemma10_nonsurge_derivative_positive_of_acceptAll_boundsSpec : Prop :=
  ∀
  (arrivalRate lowerEndpoint u T2 Q2 T1 Q1 Tbar1 Qbar1 switch12 switch21 R2 z ratio : ℝ) (density : ℝ → ℝ)
  (harrival_pos : 0 < arrivalRate) (hdensity_pos : 0 < density u) (hQ2_pos : 0 < Q2)
  (hden :
...
theorem review_lemma10_nonsurge_derivative_positive_of_acceptAll_boundsSpec_proof : review_lemma10_nonsurge_derivative_positive_of_acceptAll_boundsSpec := by
  exact review_lemma10_nonsurge_derivative_positive_of_acceptAll_bounds

def review_theorem2_multiplicative_policy_shape_source_claimSpec : Prop :=
  ∀
    (mu : Fin 2 → MeasureTheory.Measure TripLength)
    [MeasureTheory.NoAtoms (mu 0)] [MeasureTheory.NoAtoms (mu 1)]
    [MeasureTheory.IsFiniteMeasure (mu 0)] [MeasureTheory.IsFiniteMeasure (mu 1)]
...
theorem review_theorem2_multiplicative_policy_shape_source_claimSpec_proof : review_theorem2_multiplicative_policy_shape_source_claimSpec := by
  exact review_theorem2_multiplicative_policy_shape_source_claim
...
theorem review_theorem2_multiplicative_positive_finite_cutoff_not_ic_both_statesSpec_proof : review_theorem2_multiplicative_positive_finite_cutoff_not_ic_both_statesSpec := by
  exact review_theorem2_multiplicative_positive_finite_cutoff_not_ic_both_states

def review_theorem3_structured_ic_source_claimSpec : Prop :=
  ∀
    (mu : Fin 2 → MeasureTheory.Measure TripLength) (arrival : Fin 2 → ℝ)
    (R1 R2 switch12 switch21 : ℝ)
    [MeasureTheory.NoAtoms (mu 0)] [MeasureTheory.NoAtoms (mu 1)]
...
theorem review_theorem3_structured_ic_source_claimSpec_proof : review_theorem3_structured_ic_source_claimSpec := by
  exact review_theorem3_structured_ic_source_claim

/-/ Specification mirror for the first (not-yet-IC) clause of Theorem 3.
It keeps the source's surge accept-all and non-surge cutoff conclusion visible
alongside the separate full-IC clause above. -/
def review_theorem3_structured_general_policy_source_claimSpec : Prop :=
  ∀
    (mu : Fin 2 → MeasureTheory.Measure TripLength) (arrival : Fin 2 → ℝ)
    (R1 R2 switch12 switch21 : ℝ)
    [MeasureTheory.NoAtoms (mu 0)] [MeasureTheory.NoAtoms (mu 1)]
...
theorem review_theorem3_structured_general_policy_source_claimSpec_proof :
    review_theorem3_structured_general_policy_source_claimSpec := by
  exact review_theorem3_structured_general_policy_source_claim

def lemma5_full_variational_policy_formsSpec : Prop :=
  ∀
    (mu : Measure TripLength) [IsFiniteMeasure mu]
    [mu.InnerRegularCompactLTTop] [NoAtoms mu]
    (Rhat : SingleStateReward)
...
theorem lemma5_full_variational_policy_formsSpec_proof : lemma5_full_variational_policy_formsSpec := by
  exact lemma5_full_variational_policy_forms

def legacy_review_theorem4_full_structural_policy_forms_marginal_bridgeSpec : Prop :=
  ∀
    (mu : Fin 2 -> Measure TripLength)
    [NoAtoms (mu 0)] [NoAtoms (mu 1)]
    [IsFiniteMeasure (mu 0)] [IsFiniteMeasure (mu 1)]
...
theorem legacy_review_theorem4_full_structural_policy_forms_marginal_bridgeSpec_proof :
    legacy_review_theorem4_full_structural_policy_forms_marginal_bridgeSpec := by
  exact legacy_review_theorem4_full_structural_policy_forms_marginal_bridge

/-- Specification mirror for the audited literal-endpoint Theorem 4 review
surface.  It is kept separate so audit tooling can expand and compare the
whole source statement without treating proof implementation names as a
semantic match. -/
def review_theorem4_full_structural_policy_forms_directSpec : Prop :=
  ∀
    (mu : Fin 2 → Measure TripLength)
    [NoAtoms (mu 0)] [NoAtoms (mu 1)]
    [IsFiniteMeasure (mu 0)] [IsFiniteMeasure (mu 1)]
...
theorem review_theorem4_full_structural_policy_forms_directSpec_proof :
    review_theorem4_full_structural_policy_forms_directSpec := by
  exact review_theorem4_full_structural_policy_forms_direct
