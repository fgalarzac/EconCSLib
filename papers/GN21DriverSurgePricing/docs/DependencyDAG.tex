...
\node[dag_lemma, text width=4.7cm] (Lemma5) at (6.2,-8.8) {
  \textbf{Lemma 5}\\
  endpoint-complete variation gives canonical forms; the zero-density case is stated explicitly
};
...
\node[dag_result, text width=4.8cm] (Thm4) at (18.6,-13.2) {
  \textbf{Theorem 4}\\
  six price-case forms and all optima, with uniform and empty-baseline cases stated explicitly
};
