...
\node[dag_template_note,dag_template_legend] (legNote) at (4.6,0) {ordinary source\\or domain note};
}
...
\node[dag_result] (Programs) at (12.4,-4.1) {\textbf{Proposition 2 Programs}\\exact variability $1,2,3,6$ and\\one-instability for all four classes};
...
\node[dag_template_note,text width=18.2cm] (StatusNote) at (6.2,-16.4) {\textbf{Status: formalized.}  The selected source surface is covered.  Nondegeneracy conditions and the intended forms of a small number of displayed statements are recorded as source clarifications; none is a substantial paper caveat.};
