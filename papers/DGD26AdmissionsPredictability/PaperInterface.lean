...
/-- Source status: audited finite choice-function carrier. -/
abbrev paper_definition_choice_function := PaperChoiceRule α

/-- Source status: audited convention that choices lie in the offered pool. -/
abbrev paper_definition_choice_function_feasible (C : PaperChoiceRule α) : Prop :=
  paper_feasible C

/-- Source status: audited complete feasible finite choice-function model. -/
