...
Current status: formalized. Theorem 1, Theorem 2, Theorem 3, Theorem 4, Appendix A scaled-noise consequences, Appendix C Gaussian/Laplace routes, and the concrete Mallows family route are exposed through `AuditInterface.lean` and summarized in `FINAL_VALIDATION_REPORT.md`.
...
## Review Surface
`AuditInterface.lean` has 65 exported declarations:
