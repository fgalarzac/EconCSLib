...
This file preserves previous hand-written paper-folder README content.
The GitHub-facing `README.md` is now a generated status overview. As of
2026-07-25, this file is historical implementation context, not the status
authority: use `FINAL_VALIDATION_REPORT.md`, `audit/paper_statement_map.json`,
and `FORMALIZATION_PLAN.md` for the formalized closeout. In particular, do not
read older "formalized" table cells here as whole-paper coverage, or use the
old Theorem 5 row as evidence for the false archival differentiability claim.
...
- `KR21Monoculture/cited publication`
- `KR21Monoculture/cited publication`
- `KR21Monoculture/cited publication`
...
- `KR21Monoculture/docs/DependencyDAG.tex`
- `KR21Monoculture/docs/DependencyDAG.pdf`
