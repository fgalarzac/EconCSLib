...
| [GKGMM19 Iterative Local Voting](papers/GKGMM19IterativeLocalVoting) | Partially formalized | 0/42 | OK: 2723 lines | Full formalization requires proving stochastic subgradient descent convergence. Theorem 3 is proved as a constrained alternative in general and as the original statement under the explicit full-space condition. |
| [LBG24 Spatial Underreporting](papers/LBG24SpatialUnderreporting) | Partially formalized | 0/87 | OK: 8658 lines | Full formalization requires a homogeneous Poisson process and stopping time derivation |
